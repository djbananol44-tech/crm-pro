         ...
         <?php $__env->slot('heading', null, []); ?> 
            <div class="flex items-center gap-2">
                ...
                <span class="text-xs text-gray-500 font-normal ml-auto">
                    <?php echo e($this->getOnlineCount()); ?>/<?php echo e($this->getTotalManagers()); ?> в сети
                </span>
            </div>
         <?php $__env->endSlot(); ?>

        <div class="space-y-3">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->getManagers(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manager): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex items-center gap-3 p-3 rounded-xl bg-gray-50 dark:bg-gray-800/50 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-2">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($manager->isOnline()): ?>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">
                            <?php echo e($manager->getPresenceStatus()); ?>
                    ...
                    <div class="flex items-center gap-4 text-xs">
                        <div class="text-center">
                            <div class="font-bold text-gray-900 dark:text-white">
                                <?php echo e($manager->deals_count); ?>

                            </div>
                            <div class="text-gray-500">сделок</div>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($manager->getAverageRating()): ?>
                            <div class="text-center">
                                <div class="font-bold text-amber-500">
                                    ⭐ <?php echo e($manager->getAverageRating()); ?>
                    ...
                    <div class="flex-shrink-0">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($manager->hasTelegram()): ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-8 h-8 mx-auto mb-2 opacity-50']); ?>
...
<?php endif; ?>
<?php /**PATH /app/resources/views/filament/widgets/manager-presence-widget.blade.php ENDPATH**/ ?>